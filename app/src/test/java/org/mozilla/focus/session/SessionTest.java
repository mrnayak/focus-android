...
public class SessionTest {
    ...
    public void testEmptySession() {
        ...
        final Session session = new Session(RuntimeEnvironment.application, intent, TEST_URL);
    ...
    @Test
    public void testCustomTabConfigurationIsParsed() {
    ...
    @Test
    public void testingSavingAndRetrievingWebViewState() {
        final SafeIntent intent = new SafeIntent(new Intent(Intent.ACTION_VIEW, Uri.parse(TEST_URL)));
        final Session session = new Session(RuntimeEnvironment.application, intent, TEST_URL);
