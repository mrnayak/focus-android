...
/*
    ...
    private void processEraseAction(final SafeIntent intent) {
        ...
        if (browserFragment != null) {
            ...
            // TODO: Notification code (removed)
        }
    ...
    private void showUrlInputScreen() {
        ...
        final Fragment browserFragment = fragmentManager.findFragmentByTag(BrowserFragment.FRAGMENT_TAG);
        ...
        if (isShowingBrowser && browserFragment.isResumed()) {
